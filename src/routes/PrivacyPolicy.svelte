<div class="w-2/3 m-auto">
	...
	<p>
		Your privacy is important to us. It is Serenity Editor&#39;s policy to
		...
		across our website, <a href="https://serenityeditor.com"
			>https://serenityeditor.com</a
		>, and other sites we own and operate.
	</p>
	<p>
		This policy is effective as of 23 July 2021 and was last updated on 23 July
		2021.
	</p>
	...
	<p>
		...
		the time and date of your visit, the time spent on each page, other details
		about your visit, and technical details that occur in conjunction with any
	...
	<p>
		...
		general information or research data we receive from other trusted sources.
	</p>
	...
	<p>
		...
		100% secure, and no one can guarantee absolute data security. We will comply
	...
	<p>
		...
		with this privacy policy. If your personal information is no longer
		required, we will delete it or make it anonymous by removing all details
		that identify you.
	</p>
	<p>
	...
	<ul>
		...
		<li>
			...
			their services, for example, IT service providers, data storage, hosting
			and server providers, advertisers, or analytics platforms
		</li>
	...
	<p>
		...
		your personal information may not have the same data protection laws as the
		country in which you initially provided the information. If we transfer your
		personal information to third parties in other countries: (i) we will
		perform those transfers in accordance with the requirements of applicable
		law; and (ii) we will protect the transferred personal information in
	...
	<p>
		...
		you understand that we will collect, hold, use and disclose it in accordance
		with this privacy policy. You retain the right to request details of any
	...
	<p>
		...
		regulatory changes. If we decide to change this privacy policy, we will post
